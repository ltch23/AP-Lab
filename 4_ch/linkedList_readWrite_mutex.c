...
Implementar una lista enlazada ordenada de varios hilos de
  Ints con ops insert, print, member, delete, free list.
  Esta versión usa cerraduras de lectura-escritura 
  
  Compilar: gcc linkedList_readWrite.c -lpthread
  Uso: ./linkedList_readWrite.c <thread_count>
  Entrada: número total de teclas insertadas por el hilo principal
  Número total de operaciones realizadas
  Porcentaje de operaciones que son búsquedas e inserciones (operaciones restantes Son borrados).
 */
...
/* 2 * inserts_in_main intentos. */
   ...
   printf("insertar  %ld claves en una lista vacia\n", i);
